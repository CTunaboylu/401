...
// Hash table: hash function (basic) = mod(table_size:prime) + f(i) = collision resolution strategy quadratic probing where i:iteration anatomy of registers: X0:item, X1:mod, X2:quotient(reusable), X3:remainder a.k.a. hash, X4:iteration count for collision resolution, X7:hash table address, 
